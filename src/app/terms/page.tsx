...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Use" updated="July 12, 2026">
      ...
      <p>
        Any trade opportunity is subject to supplier availability, buyer qualification, counterparty due diligence, contractual agreement, applicable sanctions requirements, export controls, customs requirements, and relevant laws.
      </p>
